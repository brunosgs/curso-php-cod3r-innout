<main class="content">
    <?php
    renderTitle('Cadastro de usuário', 'Crie e atualize o usuário', 'icofont-user');
    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="password" name="password" id="password" placeholder="Informe o senha" class="form-control <?= $errors['password'] ? 'is-invalid' : '' ?>">
                <div class="invalid-feedback">
                    <?= $errors['password'] ?>
                </div>
            </div>
        ...
        <div>
            ...
            <a class="btn btn-secondary btn-lg" href="/UsersController.php">Cancelar</a>
        </div>
    </form>
</main>